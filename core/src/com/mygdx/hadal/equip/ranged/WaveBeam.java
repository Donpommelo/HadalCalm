...
import com.mygdx.hadal.battle.attacks.weapon.WaveBeamProjectile;
...
public class WaveBeam extends RangedWeapon {
	...
	private static final Vector2 PROJECTILE_SIZE = WaveBeamProjectile.PROJECTILE_SIZE;
	private static final float LIFESPAN = WaveBeamProjectile.LIFESPAN;
	private static final float BASE_DAMAGE = WaveBeamProjectile.BASE_DAMAGE;
