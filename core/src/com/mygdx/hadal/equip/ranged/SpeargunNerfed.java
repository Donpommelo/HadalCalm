...
public class SpeargunNerfed extends RangedWeapon {
	...
	private static final Vector2 PROJECTILE_SIZE = new Vector2(50, 12);
	private static final float LIFESPAN = 1.0f;
	private static final float NERFED_DAMAGE = Spear.NERFED_DAMAGE;
	...
	public String[] getDescFields() {
		return new String[] {
				String.valueOf((int) NERFED_DAMAGE),
