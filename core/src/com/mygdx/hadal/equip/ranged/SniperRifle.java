...
public class SniperRifle extends RangedWeapon {
	...
	private final static Vector2 projectileSize = new Vector2(120, 6);
	...
	public void fire(PlayState state, final Schmuck user, Vector2 startPosition, Vector2 startVelocity, final short filter) {
		...
		hbox.addStrategy(new HitboxDamageHeadshotStrategy(state, hbox, user.getBodyData(), bonusDamage, knockback));
	}
}
