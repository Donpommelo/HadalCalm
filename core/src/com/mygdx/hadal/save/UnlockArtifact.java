...
public enum UnlockArtifact {
	...
	BROOCH_OF_BETTER_DAYS(new BroochOfBetterDays(),
			GameText.BROOCH_OF_BETTER_DAYS, GameText.BROOCH_OF_BETTER_DAYS_DESC, GameText.BROOCH_OF_BETTER_DAYS_DESC_LONG,
			false, false, UnlockTag.DEFENSE, UnlockTag.OFFENSE, UnlockTag.MAGIC,
			UnlockTag.MOBILITY, UnlockTag.WEAPON_DAMAGE),
	BUCKET_OF_BATTERIES(new BucketofBatteries(), "batterybucket",
	...
	CATALOG_OF_WANT(new CatalogofWant(),
			...
			false, false, UnlockTag.MAGIC),
	CELESTIAL_ANOINTMENT(new CelestialAnointment(), "celestialanointment",
	...
	CLEPSYDRAE(new Clepsydrae(), "clepsydra",
			GameText.CLEPSYDRAE, GameText.CLEPSYDRAE_DESC, GameText.CLEPSYDRAE_DESC_LONG,
			false, false, UnlockTag.MAGIC),
	CLOCKWISE_CAGE(new ClockwiseCage(), "clockcage",
			GameText.CLOCKWISE_CAGE, GameText.CLOCKWISE_CAGE_DESC, GameText.CLOCKWISE_CAGE_DESC_LONG,
			false, false, UnlockTag.OFFENSE, UnlockTag.WEAPON_DAMAGE),
	...
	COMMUTERS_PARASOL(new CommutersParasol(),
			...
			false, false, UnlockTag.DEFENSE),
	COMPOUND_VITREOUS(new CompoundVitreous(), "vitreous",
			GameText.COMPOUND_VITREOUS, GameText.COMPOUND_VITREOUS_DESC, GameText.COMPOUND_VITREOUS_DESC_LONG,
			false, false, UnlockTag.GIMMICK),
	CONCEPT13(new Concept13(),
			GameText.CONCEPT13, GameText.CONCEPT13_DESC, GameText.CONCEPT13_DESC_LONG,
			false, false, UnlockTag.OFFENSE, UnlockTag.WEAPON_DAMAGE),
	...
	CURSED_CILICE(new CursedCilice(), "cilice",
	...
	DEAD_MANS_HAND(new DeadMansHand(), "deadmanhand",
	...
	DROWNED_POETS_INKWELL(new DrownedPoetsInkwell(), "inkwell",
			GameText.DROWNED_POETS_INKWELL, GameText.DROWNED_POETS_INKWELL_DESC, GameText.DROWNED_POETS_INKWELL_DESC_LONG,
			false, false),
	...
	FALLACY_OF_FLESH(new FallacyofFlesh(),
			...
			false, false, UnlockTag.DEFENSE),
	FARADAYS_CAGE(new FaradaysCage(), "cagefaraday",
	...
	GEMMULE(new Gemmule(),
			...
			false, false, UnlockTag.DEFENSE),
	GLUTTONOUS_GREY_GLOVE(new GluttonousGreyGlove(), "gluttonousglove",
	...
	HEARTSNATCHER(new Heartsnatcher(),
			...
			false, false, UnlockTag.OFFENSE, UnlockTag.WEAPON_DAMAGE),
	HONEYED_TENEBRAE(new HoneyedTenebrae(), "honeytenebrae",
	...
	MASK_OF_SYMPATHY(new MaskofSympathy(),
			...
			false, false),
	MATTER_UNIVERSALIZER(new MatterUniversalizer(), "matteruniveralizer",
	...
	PLUMPOWDER(new Plumpowder(),
			...
			false, false, UnlockTag.MAGIC),
	QUALIA_UMBILICA(new QualiaUmbilica(),
			GameText.QUALIA_UMBILICA, GameText.QUALIA_UMBILICA_DESC, GameText.QUALIA_UMBILICA_DESC_LONG,
			false, false, UnlockTag.GIMMICK),
	...
	SALIGRAM(new Saligram(),
			...
			false, false, UnlockTag.DEFENSE),
	SALT_SKULL_MARMALADE(new SaltSkullMarmalade(),
			GameText.SALT_SKULL_MARMALADE, GameText.SALT_SKULL_MARMALADE_DESC, GameText.SALT_SKULL_MARMALADE_DESC_LONG,
			false, false, UnlockTag.DEFENSE, UnlockTag.GIMMICK),
	SAMURAI_SHARK(new SamuraiShark(), "samuraishark",
	...
	SHILLERS_DEATHCAP(new ShillersDeathcap(),
			...
			false, false, UnlockTag.OFFENSE, UnlockTag.PROJECTILE_MODIFIER),
	SHIP_IN_A_BOTTLE(new ShipinaBottle(), "bottleship",
	...
	SIREN_CHIME(new SirenChime(),
			...
			false, false),
	SKIPPERS_BOX_OF_FUN(new SkippersBoxofFun(), "boxoffun",
	...
	SUMMONING_TWOFISH(new SummoningTwofish(),
			GameText.SUMMONING_TWOFISH, GameText.SUMMONING_TWOFISH_DESC, GameText.SUMMONING_TWOFISH_DESC_LONG,
			false, false, UnlockTag.OFFENSE, UnlockTag.PASSIVE_DAMAGE),
	...
	TOUCH_ME_NOT(new TouchMeNot(),
			GameText.TOUCH_ME_NOT, GameText.TOUCH_ME_NOT_DESC, GameText.TOUCH_ME_NOT_DESC_LONG,
			false, false, UnlockTag.PROJECTILE_MODIFIER),
