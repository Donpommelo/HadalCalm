...
public enum UnlockEquip {
	...
	BLOODLETTER(Bloodletter.class, GameText.BLOODLETTER, GameText.BLOODLETTER_DESC, GameText.BLOODLETTER_DESC_LONG),
	...
	ETHEREAL_HAUNT(EtherealHaunt.class, GameText.ETHEREAL_HAUNT, GameText.ETHEREAL_HAUNT_DESC, GameText.ETHEREAL_HAUNT_DESC_LONG),
	...
	LEAPFROG(Leapfrogger.class, GameText.LEAPFROGGER, GameText.LEAPFROGGER_DESC, GameText.LEAPFROGGER_DESC_LONG),
	...
	MIDNIGHT_POOL_CUE(MidnightPoolCue.class, GameText.MIDNIGHT_POOL_CUE, GameText.MIDNIGHT_POOL_CUE_DESC, GameText.MIDNIGHT_POOL_CUE_DESC_LONG),
