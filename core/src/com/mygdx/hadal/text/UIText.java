...
public enum UIText {
    ...
    SCREEN_OPTIONS("DISPLAY_SCREEN_OPTIONS"),
    ...
    MOUSE_RESTRICT("DISPLAY_MOUSE_RESTRICT"),
    VSYNC("DISPLAY_VSYNC"),
    ...
    LOBBY_INITIALIZED("LOBBY_NOTIF_INIT"),
    LOBBY_CREATED("LOBBY_NOTIF_CREATED"),
    ...
    ARTIFACT_INFO_VENDING("HUB_ARTIFACT_INFO_VENDING"),
    ARTIFACT_OPTION_VENDING("HUB_ARTIFACT_OPTION_VENDING"),
    ...
    VENDING_REFRESH("HUB_VENDING_REFRESH"),
    VENDING_PURCHASE("HUB_VENDING_PURCHASE"),
    DISPOSAL_SELL("HUB_DISPOSAL_SELL"),
    ...
    UI_ENTER_TO_READY("UI_ENTER_TO_READY"),
    UI_NUMKEYS_TO_VOTE("UI_NUMKEYS_TO_VOTE"),
    UI_ARCADE_ROUND("UI_ARCADE_ROUND"),
    UI_ARCADE_ROUND_LIMIT("UI_ARCADE_ROUND_LIMIT"),
    UI_ARCADE_WIN_CAP("UI_ARCADE_WIN_CAP"),
    UI_ARCADE_OVERTIME("UI_ARCADE_OVERTIME"),
    ...
    SETTING_ARCADE_BREAK_TIMER("MODE_SETTING_ARCADE_BREAK_TIMER"),
    SETTING_ARCADE_BREAK_TIMER_OPTIONS("MODE_SETTING_ARCADE_BREAK_TIMER_OPTIONS"),
    SETTING_ARCADE_ROUNDS("MODE_SETTING_ARCADE_ROUNDS"),
    SETTING_ARCADE_ROUNDS_OPTIONS("MODE_SETTING_ARCADE_ROUNDS_OPTIONS"),
    SETTING_ARCADE_WIN_CAP("MODE_SETTING_ARCADE_WIN_CAP"),
    SETTING_ARCADE_WIN_CAP_OPTIONS("MODE_SETTING_ARCADE_WIN_CAP_OPTIONS"),
    SETTING_ARCADE_STARTING_SCRAP("MODE_SETTING_ARCADE_STARTING_SCRAP"),
    SETTING_ARCADE_STARTING_SCRAP_OPTIONS("MODE_SETTING_ARCADE_STARTING_SCRAP_OPTIONS"),
    SETTING_ARCADE_BASE_SCRAP("MODE_SETTING_ARCADE_BASE_SCRAP"),
    SETTING_ARCADE_BASE_SCRAP_OPTIONS("MODE_SETTING_ARCADE_BASE_SCRAP_OPTIONS"),
    ...
    VENDING("HUB_EVENT_VENDING"),
    DISPOSAL("HUB_EVENT_DISPOSAL"),
