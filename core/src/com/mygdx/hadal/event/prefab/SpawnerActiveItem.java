 ...
 *
 */
public class SpawnerActiveItem extends Prefabrication {

	private String triggeredId, triggeringId;
	private String pool;
	
	public SpawnerActiveItem(PlayState state, int width, int height, int x, int y, String triggeredId, String triggeringId, String pool) {
