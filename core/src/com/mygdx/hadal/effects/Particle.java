...
public enum Particle {
	...
	ENERGY_CLOUD(ParticleType.DEFAULT, "particles/energy_cloud.particle"),
	GLITTER(ParticleType.DEFAULT, "particles/glitter.particle"),
	...
	NOTE_IMPACT(ParticleType.DEFAULT, "particles/note_impact.particle"),
	ORB_IMPACT(ParticleType.DEFAULT, "particles/orb_impact.particle"),
	ORB_SWIRL(ParticleType.DEFAULT, "particles/orb_swirl.particle"),
	...
	RING_TRAIL(ParticleType.DEFAULT, "particles/ring_trail.particle"),
	...
	SPLITTER_MAIN(ParticleType.DEFAULT, "particles/splitter_main.particle"),
	SPLITTER_TRAIL(ParticleType.DEFAULT, "particles/splitter_trail.particle"),
	STUN(ParticleType.DEFAULT, "particles/stun.particle"),
	TELEPORT(ParticleType.DEFAULT, "particles/teleport0.particle"),
	TELEPORT_PRE(ParticleType.DEFAULT, "particles/preteleport.particle"),
	WATER_BURST(ParticleType.DEFAULT, "particles/water_burst.particle"),
	WORMHOLE(ParticleType.DEFAULT, "particles/wormhole.particle"),

	BLIND(ParticleType.DEFAULT, "particles/blind.particle"),
	...
	PICKUP_AMMO(ParticleType.DEFAULT, "particles/ammo_pickup.particle"),
	...
	BRIGHT_TRAIL(ParticleType.DEFAULT, "particles/bright_trail.particle"),
	STAR_TRAIL(ParticleType.DEFAULT, "particles/star_trail.particle"),
