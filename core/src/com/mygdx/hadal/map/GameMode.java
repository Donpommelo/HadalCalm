...
public enum GameMode {
    ...
    DEATHMATCH("dm",
        ...
        new DisplayUITag("SCOREBOARD"), new SpawnWeapons(), new ToggleKillsScore(), new ToggleWeaponDrops(),
    ...
    EGGPLANTS("objective,dm", DEATHMATCH,
        ...
        new DisplayUITag("SCOREBOARD"), new SpawnWeapons(),  new ToggleWeaponDrops(),
