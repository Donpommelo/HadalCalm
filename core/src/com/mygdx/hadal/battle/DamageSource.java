...
public enum DamageSource {
    ...
    DIATOM_BURST(DamageSourceType.WEAPON, GameText.DIATOM_BURST),
    ...
    NEBULIZER(DamageSourceType.WEAPON, GameText.NEBULIZER),
    ...
    RECOMBINANT_SHOTRIFLE(DamageSourceType.WEAPON, GameText.RECOMBINANT_SHOTRIFLE),
    ...
    CONCEPT13(DamageSourceType.ARTIFACT, GameText.CONCEPT13),
    ...
    TOUCH_ME_NOT(DamageSourceType.ARTIFACT, GameText.TOUCH_ME_NOT),
