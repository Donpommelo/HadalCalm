...
public class MockGL2 implements GL20 {
    ...
    @Override
    public String glGetString(int name) { return null; }
    ...
    @Override
    public String glGetActiveAttrib(int program, int index, IntBuffer size, IntBuffer type) { return null; }

    @Override
    public String glGetActiveUniform(int program, int index, IntBuffer size, IntBuffer type) { return null; }
    ...
    @Override
    public String glGetProgramInfoLog(int program) { return null; }
    ...
    @Override
    public String glGetShaderInfoLog(int shader) { return null; }
